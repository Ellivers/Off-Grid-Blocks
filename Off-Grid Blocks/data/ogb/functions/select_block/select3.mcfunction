...
execute if entity @s[type=minecraft:shulker] run effect give @s minecraft:glowing 1000000 0 true
execute if entity @s[type=minecraft:pig,tag=ogb.block_visual.fb] run tag @s add ogb.particles