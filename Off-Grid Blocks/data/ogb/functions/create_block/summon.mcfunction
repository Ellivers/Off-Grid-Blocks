...
#tag=ogb.block_visual.fb,tag=ogb.block_collision.shulker

forceload add ~200 ~
execute positioned ~200 ~ ~ run function ogb:create_block/summon/fb_shulker
execute align xyz run summon minecraft:area_effect_cloud ~.5 ~ ~.5 {Age: -2147483648, Duration: -1, WaitTime: -2147483648, Tags: ["ogb.block_placement_marker","off_grid_blocks"]}
