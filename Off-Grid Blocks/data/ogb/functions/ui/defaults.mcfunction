...
tellraw @s {"text": "\nCollision:","bold": true}
execute if entity @s[tag=!ogb.block_collision.none] run tellraw @s {"text": "[None]","color": "green","hoverEvent": {"action": "show_text","value": "No collision"},"clickEvent": {"action": "run_command","value": "/function ogb:ui/select_default/coll.none"}}
execute if entity @s[tag=ogb.block_collision.none] run tellraw @s {"text": "[None]","color": "gray","hoverEvent": {"action": "show_text","value": "No collision [selected]"}}
...
execute if entity @s[tag=ogb.block_collision.shulker] run tellraw @s {"text": "[Full moveable block]","color": "gray","hoverEvent": {"action": "show_text","value": "Use a full moveable block as the collision (shulker entity) [selected]"}}
